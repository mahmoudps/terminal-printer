...
const bridge: AgentBridge = {
  ...
  testPrintTo: (printer, type) => ipcRenderer.invoke(IPC.testPrintTo, printer, type),
  setDefaultPrinter: (name) => ipcRenderer.invoke(IPC.setDefaultPrinter, name),
  runDiagnostics: () => ipcRenderer.invoke(IPC.runDiagnostics),
  getHealth: () => ipcRenderer.invoke(IPC.getHealth),
  installVirtualPrinter: () => ipcRenderer.invoke(IPC.installVirtualPrinter),
  removeVirtualPrinter: () => ipcRenderer.invoke(IPC.removeVirtualPrinter),
  getVirtualPrinterStatus: () => ipcRenderer.invoke(IPC.getVirtualPrinterStatus),
